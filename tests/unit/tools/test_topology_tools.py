...
def sample_topology_data():
    """Sample topology data from UniFi API."""
    return {
        "data": {
            "nodes": [
                {
...
class TestGetNetworkTopology:
    ...
    @pytest.mark.asyncio
    async def test_get_network_topology_success(self, mock_settings, sample_topology_data):
        ...
        with patch("src.tools.topology.UniFiClient") as mock_client:
            ...
            mock_instance.get = AsyncMock(return_value=sample_topology_data)
    ...
    async def test_get_network_topology_empty(self, mock_settings):
        ...
        with patch("src.tools.topology.UniFiClient") as mock_client:
            ...
            mock_instance.authenticate = AsyncMock()
            mock_instance.resolve_site_id = AsyncMock(return_value="default")
            mock_instance.get = AsyncMock(return_value={"data": {"nodes": [], "clients": []}})
    ...
    @pytest.mark.asyncio
    async def test_get_network_topology_with_coordinates(self, mock_settings, sample_topology_data):
...
class TestGetDeviceConnections:
    ...
    async def test_get_device_connections_specific_device(
        self, mock_settings, sample_topology_data
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_device_connections_all_devices(self, mock_settings, sample_topology_data):
...
class TestGetPortMappings:
    ...
    @pytest.mark.asyncio
    async def test_get_port_mappings_specific_device(self, mock_settings, sample_topology_data):
...
class TestExportTopology:
    ...
    @pytest.mark.asyncio
    async def test_export_topology_json(self, mock_settings, sample_topology_data):
    ...
    @pytest.mark.asyncio
    async def test_export_topology_graphml(self, mock_settings, sample_topology_data):
    ...
    @pytest.mark.asyncio
    async def test_export_topology_dot(self, mock_settings, sample_topology_data):
...
class TestGetTopologyStatistics:
    ...
    @pytest.mark.asyncio
    async def test_get_topology_statistics(self, mock_settings, sample_topology_data):
